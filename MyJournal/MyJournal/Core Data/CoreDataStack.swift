...
final class CoreDataStack {
  ...
  private init() {
    guard let modelURL = Bundle.main.url(forResource: "JournalDatamodel", withExtension: "momd") else {
  ...
  private static var storeURL: URL {
    ...
    let storeURL = docURL.appendingPathComponent("JournalDatamodel.sqlite")
    return storeURL
  }
